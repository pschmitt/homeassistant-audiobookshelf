"""Webhook support for Audiobookshelf Kindle."""
...
def async_register_webhook(
    hass: HomeAssistant,
    entry: ConfigEntry,
    manager: AudiobookshelfKindleManager,
) -> None:
    ...
    async def _handle_webhook(
        ...
        try:
            ...
            _LOGGER.exception("Failed to process Audiobookshelf Kindle webhook")
